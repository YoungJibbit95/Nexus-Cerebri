  ...
  <div class="mobile-plane" aria-hidden="true">
    ...
    {#each candidates as candidate, index}
      <div
        ...
        style={"--candidate-top:" + candidate.mobileTop + "%;--candidate-height:" + candidate.mobileHeight + "%;--lane:" + (index % 2)}
      >
