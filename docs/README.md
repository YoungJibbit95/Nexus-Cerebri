...
Accepted ADRs explicitly amending a named Master rule, with a synchronized Master update,
precede the Master; domain standards, agent boundaries and roadmap follow. Historical reviews
and progress logs never override normative documents. Moving files does not change authority.
